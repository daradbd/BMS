(function () {
    ...
    angular
        ...
        .controller("employeeCtrl", ["designationResource", "departmentResource", "currencyResource", "languageResource", "countryResource", "cityResource", "collaboratorResource", employeeCtrl]);
    function employeeCtrl(designationResource, departmentResource, currencyResource, languageResource, countryResource, cityResource, collaboratorResource) {
        var vm = this;
        vm.collaborators = [];
        vm.Languages = [];
        vm.Currencys = [];
