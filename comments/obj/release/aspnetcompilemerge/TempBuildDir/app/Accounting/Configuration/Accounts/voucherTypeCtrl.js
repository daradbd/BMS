(function () {
    ...
    function voucherTypeCtrl(voucherTypeResource) {
        ...
        //Get All Data List
        function GetList() {
            voucherTypeResource.query().$promise.then(function (data) {
        ...
        vm.Save = function (isValid) {
            if (isValid) {
                voucherTypeResource.save(vm.voucherType).$promise.then(
        ...
        //Get Single Record
        vm.Get = function (id) {
            voucherTypeResource.get({ 'ID': id }).$promise.then(function (voucherType) {
