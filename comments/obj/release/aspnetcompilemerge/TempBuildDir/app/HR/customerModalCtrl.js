(function () {
    ...
    angular
        ...
        .controller("customerModalCtrl", ["customerTypeResource", "currencyResource", "languageResource", "countryResource", "cityResource", "collaboratorResource", "customerFormData", "$modalInstance", customerModalCtrl]);
    function customerModalCtrl(customerTypeResource, currencyResource, languageResource, countryResource, cityResource, collaboratorResource, customerFormData, $modalInstance) {
        var vm = this;
        vm.collaborators = [];
        vm.Languages = [];
        vm.Currencys = [];
            ...
            if (isValid) {
                ...
                collaboratorResource.save(vm.collaborator).$promise.then(
                    function (data, responseHeaders) {
                        ...
                        $modalInstance.close(vm.collaborator);
                        toastr.success("Save Successful");
                        vm.isLoad = false;
                    }, function (error) {
                        // error handler
