(function () {
    ...
    function salesDeliveryCategoryCtrl(salesDeliveryCategoryResource) {
        ...
        //Get All Data List
        function GetList() {
            salesDeliveryCategoryResource.query(function (data) {
        ...
        vm.Save = function (isValid) {
            if (isValid) {
                salesDeliveryCategoryResource.save(vm.salesDeliveryCategory,
        ...
        //Get Single Record
        vm.Get = function (id) {
            salesDeliveryCategoryResource.get({ 'ID': id }, function (salesDeliveryCategory) {
        ...
        vm.Update = function (isValid) {
            if (isValid) {
                salesDeliveryCategoryResource.update({ 'ID': vm.salesDeliveryCategory.SalesDeliveryCategoryID }, vm.salesDeliveryCategory);
