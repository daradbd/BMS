    ...
    app.config(["$stateProvider",
                ...
                function ($stateProvider, $urlRouterProvider) {
                    ...
                    $stateProvider
                        ...
                        .state("bankLoanType", {
                            url: "/bankLoanType",
                            templateUrl: "app/Accounting/Configuration/Banks/bankLoanType.html",
                            controller: "bankLoanTypeCtrl as vm"
                        })
                        //bankLoan  
                        .state("bankLoan", {
                            url: "/bankLoan",
                            templateUrl: "app/Accounting/Configuration/Banks/bankLoan.html",
                            controller: "bankLoanCtrl as vm"
                        })
                        //bankLoanTransaction  
                        .state("bankLoanTransaction", {
                            url: "/bankLoanTransaction",
                            templateUrl: "app/Accounting/Configuration/Banks/bankLoanTransaction.html",
                            controller: "bankLoanTransactionCtrl as vm"
                        })
