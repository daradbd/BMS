(function () {
    ...
    angular
        ...
        .controller("purchaseOrderListCtrl", ["collaboratorResource", "purchasePermitResource", "purchasePermitDescriptionResource", "purchaseOrderResource", "purchaseOrderDescriptionResource", "appAuth", purchaseOrderListCtrl]);
    function purchaseOrderListCtrl(collaboratorResource, purchasePermitResource, purchasePermitDescriptionResource, purchaseOrderResource, purchaseOrderDescriptionResource, appAuth) {
        var vm = this;
        vm.purchaseOrders = [];
        vm.purchasePermits = [];
        vm.purchasePermit = {};
