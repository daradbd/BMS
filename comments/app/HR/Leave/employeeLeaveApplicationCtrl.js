(function () {
    ...
    function employeeLeaveApplicationCtrl(collaboratorResource, Util, employeeLeaveGroupResource, employeeLeaveTypeResource, employeeLeaveApplicationResource) {
        ...
        //Get All Data List
        function GetList() {
            employeeLeaveApplicationResource.query(function (data) {
        ...
        vm.Save = function (isValid) {
            if (isValid) {
                ...
                employeeLeaveApplicationResource.save(vm.employeeLeaveApplication,
        ...
        //Get Single Record
        vm.Get = function (id) {
            employeeLeaveApplicationResource.get({ 'ID': id }, function (employeeLeaveApplication) {
        ...
        vm.Update = function (isValid) {
            if (isValid) {
                employeeLeaveApplicationResource.update({ 'ID': vm.employeeLeaveApplication.EmployeeLeaveApplicationID }, vm.employeeLeaveApplication);
