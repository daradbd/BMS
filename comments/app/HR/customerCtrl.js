(function () {
    ...
    angular
        ...
        .controller("customerCtrl", ["customerTypeResource", "currencyResource", "languageResource", "countryResource", "cityResource", "collaboratorResource", customerCtrl]);
    function customerCtrl(customerTypeResource, currencyResource, languageResource, countryResource, cityResource, collaboratorResource) {
        var vm = this;
        vm.collaborators = [];
        vm.Languages = [];
        vm.Currencys = [];
