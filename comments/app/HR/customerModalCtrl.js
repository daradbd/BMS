(function () {
    ...
    function customerModalCtrl(customerTypeResource, currencyResource, languageResource, countryResource, cityResource, collaboratorResource, customerFormData, $uibModalInstance, appAuth) {
        var vm = this;
        vm.IsCompany=true;
        //if(customerFormData.IsCompany){
        //    vm.IsCompany=customerFormData.IsCompany;
        //}
        vm.collaborators = [];
        vm.Languages = [];
        vm.Currencys = [];
      ...
      //  appAuth.checkPermission();
        ...
        function GetList() {
            ...
            collaboratorResource.query({ '$filter': 'IsCustomer eq true and IsCompany eq ' + vm.IsCompany }).$promise.then(function (data) {
